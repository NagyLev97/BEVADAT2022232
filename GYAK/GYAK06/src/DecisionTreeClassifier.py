...
#             if best_split['info_gain'] > 0:
#                 left_subtree = self.build_tree(best_split['datas_left'], curr_depth + 1)
#                 right_subtree = self.build_tree(best_split['datas_right'], curr_depth + 1)

#                 return Node(best_split['feture_index'], best_split['threshold'], left_subtree, right_subtree, best_split['info_gain'])
